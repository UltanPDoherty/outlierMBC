...
distrib_diff_gmm <- function(x, z, prop, mu, sigma) {
  ...
  for (g in seq_len(comp_num)) {
    dd_g <- distrib_diff_mahalanobis3(x, z[, g], mu[[g]], sigma[[g]])
...
distrib_diff_mahalanobis2 <- function(
    x,
    z_g,
    mu_g,
    sigma_g) {
...
distrib_diff_mahalanobis3 <- function(
    x,
    z_g,
    mu_g,
    sigma_g) {
...
distrib_diff_mahalanobis4 <- function(
    x,
    z_g,
    mu_g,
    sigma_g) {
...
distrib_diff_mahalanobis5 <- function(
    x,
    z_g,
    mu_g,
    sigma_g) {
...
distrib_diff_mahalanobis6 <- function(
    x,
    z_g,
    mu_g,
    sigma_g) {
