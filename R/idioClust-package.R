...
#'
#' Exported Functions:
#' * `idio_gmm` - Identify multivariate outliers while clustering the data with a
...
#' * `simulate_noisy_mlr` - Simulate data from a multiple linear regression model
#'                          with response variable outliers.
"_PACKAGE"
